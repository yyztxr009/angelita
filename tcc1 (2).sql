...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 28/05/2026 às 19:52
...
(56, 44, '', 'aguardando', NULL, 0.00),
(57, 45, '', 'aguardando', NULL, 0.00),
(58, 46, '', 'aguardando', NULL, 0.00),
(59, 47, '', 'aguardando', NULL, 0.00);
...
(16, 44, 'pix', 'pendente', 25.00),
(17, 45, 'pix', 'pendente', 17.00),
(18, 46, 'pix', 'pendente', 17.00),
(19, 47, 'pix', 'pendente', 17.00);
...
(38, 1, '2025-12-13 13:48:42', 17.00, 'entregue', 1, ''),
(44, NULL, '2026-04-13 11:43:09', 25.00, 'entregue', 10, ''),
(45, NULL, '2026-04-15 11:56:24', 17.00, 'entregue', 10, ''),
(46, NULL, '2026-04-15 12:19:12', 17.00, 'entregue', 10, ''),
(47, NULL, '2026-04-15 12:21:47', 17.00, 'entregue', 10, '');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `email_verificado` int DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`)
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `senha_hash`, `tipo`, `token_recuperacao`, `token_expira_em`, `cpf`, `telefone`, `endereco`, `data_nascimento`, `codigo_verificacao`, `email_verificado`) VALUES
(1, 'Dimitri', 'Darksity09@gmail.com', '$2y$10$Wequv8dYkkaSn4Xe0YO3u.b08ThEpV10mijp02Xr8A2Slbz4wVpWG', 'admin', NULL, NULL, '', '', '', '0000-00-00', NULL, 0),
(3, 'Gabriela Tavares', 'tavareti@gmail.com', '$2y$10$akZwQIUfsUYX7j1KxD.yVONtvfAA3Xn65hHBYVn6bxm/xooK47LVS', 'cliente', 'a9cca2ed75af2e78751acf2de9bc14699395af8b6fe3ed74727f6264bc130d8b', '2025-12-12 16:20:29', '05793542027', '55998733456', '', '2008-02-11', NULL, 0),
(4, 'Dimitri', 'dimitri55@gmail.com', '$2y$10$QoYIIa8pD8IF6F2YDw8zAuaPj.1NaP0eFc8fgyC/w9sbhxgf2EKAm', 'cliente', NULL, NULL, '', '', NULL, NULL, NULL, 0),
(5, 'USUARIO1', 'usuario10@gmail.com', '$2y$10$QIMdE.cwoEdAbI4kDbZEeeauCI/rSv3TXQxSnzoMuVzHt5RqLnLgK', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(10, 'Usuario Cadastrado', 'cadastro@gmail.com', '$2y$10$JQlS5kMemPKwZhB02rEvmeq0e/lYRykEZ.NpW9punTslbUWya7w0S', 'admin', NULL, NULL, '', '', NULL, NULL, NULL, 0),
(15, 'Dimitri Tolentino Fernandes', 'dimitri.2023317573@aluno.iffar.edu.br', '$2y$10$8GZlfallsHh85JOafsJYZOH75OAcHfzE63OMGrpoV.f9wXaUwugYy', 'admin', NULL, NULL, '03713500002', NULL, NULL, '2010-05-27', NULL, 1);
